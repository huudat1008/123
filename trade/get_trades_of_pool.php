...
$trades_month = isset($_GET['trades_month']) ? $_GET['trades_month'] : false;
$hightyield = isset($_GET['hightyield']) ? $_GET['hightyield'] : false;
...
// query trades
$stmt = $trade->getTradesOfPool($account_id, $pool_id, $trades_month, $hightyield, $first_day_of_month, $last_day_of_month, $date, $offset, $is_demo);
